...
public class Constants {
	...
	public static final double LASER_VEL = 40.0;
	...
	//JSON
	public static final String SCORE_PATH = FileSystemView.getFileSystemView().getDefaultDirectory().getPath() +"\\Space_Ship_Game\\data.json"; 
