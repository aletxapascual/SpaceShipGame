...
public class GameState extends State{
	...
	//Lista de todos los objetos que se van a crear
	...
	public void divideMeteor(Meteor meteor) {
		...
		//Numero de meteoros que se debe dividir
	...
	//Inicializar oleada de meteoritos
		private void startWave() {
			//Mensaje del # de wave
			messages.add(new Message(new Vector2D(Constants.WIDTH/2, Constants.HEIGHT/2), false,"WAVE "+waves, Color.WHITE, true, Assets.fontBig));
	...
	public void update(float dt) {
		...
		for(int i = 0; i < explosions.size(); i++){
			//checar si la animacion ya llego a su fin
